...
4. Rename the file to `cat_sitting_XXXXXXXX.png` or `cat_standing_template.png`, replacing `XXXXXXXX` with something that describes what you have drawn and place it in the `cats` folder.
